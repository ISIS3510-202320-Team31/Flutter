          ...
          ChangeNotifierProvider<UserVM>(
            ...
            child: Consumer<UserVM>(
              builder: (context, viewModel, _) {
                print("userId: ${viewModel.userId.status}");
                switch (viewModel.userId.status) {
                  case Status.LOADING:
                    print("Log :: LOADING");
                    return Container(
                      child: Center(
                    ...
                    return ListView(
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          height: 250,
                          child:
                              Image.asset('assets/images/HIVE_LOGO_small.png'),
                        ),
                        Align(
                          ...
                          child: Padding(
                            ...
                            child: Text(
                              ...
                              style: TextStyle(
                                ...
                                color:
                                    Colors.black, // Color del texto (opcional)
                              ),
                            ),
                          ),
                        ),
                              ...
                              child: Text(
                                ...
                                style: TextStyle(
                                  ...
                                  fontWeight: FontWeight
                                      .bold, // Peso de la fuente en negrita
                                  color: Colors
                                      .black, // Color del texto (opcional)
                                ),
                              ),
                  ...
                  case Status.COMPLETED:
                    print("Log :: User logged in! Redirecting...");
                    return Builder(
                      builder: (context) {
